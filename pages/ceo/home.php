...
<section class="px-4 py-6 bg-gray-50 min-h-screen">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        <?php while ($row = mysqli_fetch_assoc($query)) { ?>
            <a href="?page=ceo_type&period_id=<?php echo $row['period_id'] ?>" class="group block bg-white border border-gray-200 rounded-xl p-6 shadow hover:shadow-lg hover:border-red-600 transition duration-300 ease-in-out">
